...
- Cosine -> linear? _Code done_ _Script done_ _Job submitted_
- No warm up? _Code done_ _Script done_ _Job submitted_
...
- 2 epochs on first 5B dataset vs 1 epoch on 10B dataset _Job submitted_
  - Which one is better?
...
- Smaller _Code done_ _Script done_ _Job submitted_
